...
public class Video {
    ...
    public Long getId(){return id;} public Long getUserId(){return userId;} public String getTitle(){return title;} public String getDescription(){return description;} public String getCoverUrl(){return coverUrl;} public String getHlsUrl(){return hlsUrl;} public int getDuration(){return duration;} public VideoType getVideoType(){return videoType;} public Long getCategoryId(){return categoryId;} public Visibility getVisibility(){return visibility;} public VideoStatus getStatus(){return status;} public boolean isDownloadEnabled(){return downloadEnabled;} public long getViewCount(){return viewCount;} public long getLikeCount(){return likeCount;} public long getDislikeCount(){return dislikeCount;} public long getCommentCount(){return commentCount;} public long getFavoriteCount(){return favoriteCount;} public Instant getPublishedAt(){return publishedAt;}
