...
public class AuthController {
    ...
    @PostMapping("/password/reset") public ApiResponse<Map<String,Boolean>> reset(@Valid @RequestBody AuthDtos.ResetPasswordRequest request){service.resetPassword(request); return ApiResponse.ok(Map.of("success",true));}
