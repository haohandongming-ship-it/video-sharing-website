...
public class DevDataSeeder implements ApplicationRunner {
    ...
    @Override @Transactional public void run(ApplicationArguments args){
        ...
        jdbc.update("INSERT INTO feeds(user_id,content,type,like_count,comment_count,repost_count,status) VALUES(?,?,?,?,?,?,?)",creator,"新视频发布啦，聊聊一个视频平台从零到一的架构取舍。","ORIGINAL",28,1,3,"VISIBLE");
        jdbc.update("INSERT INTO feeds(user_id,content,type,like_count,comment_count,repost_count,status) VALUES(?,?,?,?,?,?,?)",moderator,"今日社区精选已经更新，欢迎分享你的创作。","ORIGINAL",16,0,2,"VISIBLE");
