// 登录管理员后打开指定后台页面并截图（用于人工确认渲染结果）。
//   node scripts/shot-admin.mjs <路径> <输出文件> [baseUrl]
const path = process.argv[2] ?? '/admin/reviews';
const out = process.argv[3] ?? 'gui-test-screenshots/admin-reviews.png';
